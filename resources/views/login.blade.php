    ...
    <body class="bo-login">
        ...
        <form action="{{ route('login') }}" class="cont-login">
            ...
            <div class="input-group mb-3">
                ...
                <input type="password" name="password" id="password" class="form-login" placeholder="Password" aria-label="Username" aria-describedby="basic-addon1">
            </div>
            <button class="btn-form-submit">Login</button>
        </form>
        </div>
