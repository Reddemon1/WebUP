    ...
    <body>
        <div class="fade" style="background: black; background-size:cover;width:100%;height:1080px;display:inline"></div>
            <nav style="height:60px;" class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
